...
public class AllProcessController {
    ...
    public void work() throws InterruptedException, TelegramApiException {
        ...
        sendMessage.setChatId("1139333571");
        telegramDataStoreModel = new TelegramDataStoreModel("CaptchaSlove_bot", "6928830332:AAGzv3fN_k8MfITzJeOyjqtsDqfWJviF913", sendMessage);
